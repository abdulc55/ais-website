...
class AnimationController {
    ...
    public render() {
        ...
        ctx.save()
        // Center the animation in the actual container
        ctx.translate(this.width / 2, this.height / 2)

        // Scale up to fill the hero — the raw animation is ~340px across,
        // so we scale relative to the container to make it dominant
...
export function SpiralAnimation() {
    ...
    useEffect(() => {
        ...
        const setup = () => {
            // Use the actual container size, not window size
            ...
            animationRef.current = new AnimationController(canvas, ctx, w, h)
        }
